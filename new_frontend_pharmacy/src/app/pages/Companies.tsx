...
import { createCompany, getCompanies, getUsers } from '../lib/api';
...
export function Companies() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        const [companyList, users] = await Promise.all([getCompanies(token), getUsers(token)]);
