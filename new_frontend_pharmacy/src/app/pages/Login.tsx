...
export function Login() {
  ...
  const demoCredentials = [
    { role: 'Superadmin', email: 'superadmin@pharma.local', password: 'SuperAdmin123!' },
    { role: 'Manager', email: 'manager@acme.local', password: 'Manager123!' },
    { role: 'Employee', email: 'evan@acme.local', password: 'Employee123!' },
  ];
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 mt-2 italic">
                Use the seeded backend credentials shown above.
              </p>
            </div>
          </div>
        </div>
