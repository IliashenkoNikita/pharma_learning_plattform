...
export function MyCourses() {
  ...
  const inProgressCourses = myEnrollments.filter((e) => e.status === EnrollmentStatus.InProgress);
  const completedCourses = myEnrollments.filter((e) => e.status === EnrollmentStatus.Completed);
  const notStartedCourses = myEnrollments.filter((e) => e.status === EnrollmentStatus.NotStarted);
